...
fprintf('\n=============================\n');
fprintf('MOBILE MANIPULATOR SIMULATION\n');
fprintf('=============================\n');
...
%% Redundancy Resolution Using Pseudoinverse Method

fprintf('\n-------------------------------------------------------\n');
fprintf('Redundancy Resolution Using Pseudoinverse Method\n');
fprintf('-------------------------------------------------------\n');
...
for i=1:traversals_ellipse*360
    ...
    % Plot
%     figure(4)
%     plot(x_ellipse(1:360),y_ellipse(1:360),'--','Color',[50,50,50]/255)
%     hold on
%     plot(X_E_ellipse,Y_E_ellipse,'Color',[236,106,49]/255)
...
xlabel("X (m)")
ylabel("Y (m)")
title(["Redundancy Resolution","Pseudoinverse Method"])
legend("Desired Trajectory","Actual Trajectory")
xlim([-5,5])
ylim([-5,5])
pbaspect([1,1,1])
hold off
RMSE_ellipse = sqrt(sum((x_ellipse-X_E_ellipse).^2+(y_ellipse-Y_E_ellipse).^2)/length(x_ellipse));
fprintf("RMSE for elliptical trajectory: %d m\n",RMSE_ellipse)
...
for i=1:traversals_rectangle*360
    ...
    % Plot
%     figure(6)
%     plot(x_rectangle(1:360),y_rectangle(1:360),'--','Color',[50,50,50]/255)
%     hold on
%     plot(X_E_rectangle,Y_E_rectangle,'Color',[236,106,49]/255)
...
pbaspect([1,1,1])
hold off
RMSE_rectangle = sqrt(sum((x_rectangle-X_E_rectangle).^2+(y_rectangle-Y_E_rectangle).^2)/length(x_rectangle));
fprintf("RMSE for rectangular trajectory: %d m\n",RMSE_rectangle)

%% Redundancy Resolution Using Augmented Task-Space Method (Theta_1_Dot + Theta_2_Dot = 0)

fprintf('\n-------------------------------------------------------\n');
fprintf('Redundancy Resolution Using Augmented Task-Space Method\n');
fprintf('Theta_1_Dot + Theta_2_Dot = 0\n');
fprintf('-------------------------------------------------------\n');
...
xlabel("X (m)")
ylabel("Y (m)")
title(["Redundancy Resolution","Augmented Task-Space Method"])
subtitle('$\dot{\theta_1} + \dot{\theta_2} = 0$','Interpreter','latex')
legend("Desired Trajectory","Actual Trajectory")
xlim([-5,5])
ylim([-5,5])
pbaspect([1,1,1])
...
%% Redundancy Resolution Using Augmented Task-Space Method (Theta_1_Dot = 0)

fprintf('\n-------------------------------------------------------\n');
fprintf('Redundancy Resolution Using Augmented Task-Space Method\n');
fprintf('Theta_1_Dot = 0\n');
fprintf('-------------------------------------------------------\n');
...
ylabel("Y (m)")
title(["Redundancy Resolution","Augmented Task-Space Method"])
subtitle('$\dot{\theta_1} = 0$','Interpreter','latex')
legend("Desired Trajectory","Actual Trajectory")
xlim([-5,5])
ylim([-5,5])
pbaspect([1,1,1])
...
%% Redundancy Resolution Using Artificial Potential Method

fprintf('\n-------------------------------------------------------\n');
fprintf('Redundancy Resolution Using Artificial Potential Method\n');
fprintf('-------------------------------------------------------\n');
...
xlabel("X (m)")
ylabel("Y (m)")
title(["Redundancy Resolution","Artificial Potential Method"])
subtitle('$V = 0.66*\phi^2 + \theta_1^2 + 0.25*\theta_2^2$','Interpreter','latex')
legend("Desired Trajectory","Actual Trajectory")
xlim([-5,5])
ylim([-5,5])
pbaspect([1,1,1])
...
%% Configuration-Space Resolved-Rate Motion Control

fprintf('\n-------------------------------------------------------\n');
fprintf('Configuration-Space Resolved-Rate Motion Control\n');
fprintf('-------------------------------------------------------\n');
...
for i = 1:length(q_d_ellipse)
    ...
    % Plot
%     figure(20)
%     plot(X_d_ellipse(1:360),Y_d_ellipse(1:360),'--','Color',[50,50,50]/255)
%     hold on
%     plot(X_E_ellipse,Y_E_ellipse,'Color',[236,106,49]/255)
%     PlotRobot(q_ellipse(:,i),robot_params)
%     legend("Desired Trajectory","Actual Trajectory")
...
xlabel("X (m)")
ylabel("Y (m)")
title(["Closed-Loop Resolved-Rate Motion Control","Configuration-Space"])
legend("Desired Trajectory","Actual Trajectory")
xlim([-5,5])
ylim([-5,5])
pbaspect([1,1,1])
hold off
RMSE_ellipse = sqrt(sum((X_d_ellipse-X_E_ellipse).^2+(Y_d_ellipse-Y_E_ellipse).^2)/length(X_d_ellipse));
fprintf("RMSE for elliptical trajectory: %d m\n",RMSE_ellipse)
...
for i = 1:length(q_d_rectangle)
    ...
    % Plot
%     figure(22)
%     plot(X_d_rectangle(1:360),Y_d_rectangle(1:360),'--','Color',[50,50,50]/255)
%     hold on
%     plot(X_E_rectangle,Y_E_rectangle,'Color',[236,106,49]/255)
%     PlotRobot(q_rectangle(:,i),robot_params)
%     legend("Desired Trajectory","Actual Trajectory")
...
pbaspect([1,1,1])
hold off
RMSE_rectangle = sqrt(sum((X_d_rectangle-X_E_rectangle).^2+(Y_d_rectangle-Y_E_rectangle).^2)/length(X_d_rectangle));
fprintf("RMSE for rectangular trajectory: %d m\n",RMSE_rectangle)

%% Task-Space Resolved-Rate Motion Control

fprintf('\n-------------------------------------------------------\n');
fprintf('Task-Space Resolved-Rate Motion Control\n');
fprintf('-------------------------------------------------------\n');
...
xlabel("X (m)")
ylabel("Y (m)")
title(["Closed-Loop Resolved-Rate Motion Control","Task-Space"])
legend("Desired Trajectory","Actual Trajectory")
xlim([-5,5])
ylim([-5,5])
pbaspect([1,1,1])
